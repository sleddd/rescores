 ...
 */
?>
<!-- wp:group {"tagName":"header","style":{"spacing":{"padding":{"top":"0","right":"1rem","bottom":"1rem","left":"1rem"}}},"className":"alignfull header shadow-lg bg-gray-50"} -->
	<header class="wp-block-group alignfull header shadow-lg bg-gray-50" style="padding-top:0;padding-right:1rem;padding-bottom:1rem;padding-left:1rem">
