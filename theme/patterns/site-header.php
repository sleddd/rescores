 ...
 */
?>
<!-- wp:group {"tagName":"header","style":{"spacing":{"padding":{"top":"1.5rem","right":"1rem","bottom":"1.7rem","left":"1rem"}}},"className":"alignfull header shadow-lg bg-gray-50"} -->
	<header class="wp-block-group alignfull header shadow-lg bg-gray-50" style="padding-top:1.5rem;padding-right:1rem;padding-bottom:1.7rem;padding-left:1rem">
