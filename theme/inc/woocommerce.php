 ...
 * @link https://github.com/Automattic/_s/blob/master/js/customizer.js
 ...
 * @return void
 */
function _rs_woocommerce_setup() {
	add_theme_support(
		'woocommerce',
		array(
...
add_action( 'after_setup_theme', '_rs_woocommerce_setup' );
 ...
 */
function _rs_woocommerce_active_body_class( $classes ) {
	$classes[] = 'woocommerce-active';

	return $classes;
}
add_filter( 'body_class', '_rs_woocommerce_active_body_class' );
 ...
 */
function _rs_woocommerce_related_products_args( $args ) {
	$defaults = array(
		'posts_per_page' => 3,
		'columns'        => 3,
	);
...
add_filter( 'woocommerce_output_related_products_args', '_rs_woocommerce_related_products_args' );
...
if ( ! function_exists( '_rs_woocommerce_wrapper_before' ) ) {
	/**
	 * Before Content.
	 *
	 ...
	 * @return void
	 */
	function _rs_woocommerce_wrapper_before() {
		?>
...
if ( ! function_exists( '_s_woocommerce_wrapper_after' ) ) {
	 ...
	 * @return void
	 */
	function _rs_woocommerce_wrapper_after() {
		?>
			</main><!-- #main -->
		<?php
	}
}
add_action( 'woocommerce_after_main_content', '_rs_woocommerce_wrapper_after' );
...
if ( ! function_exists( '_rs_woocommerce_cart_link_fragment' ) ) {
	/**
	 * Cart Fragments.
	 *
...
if ( ! function_exists( '_rs_woocommerce_header_cart' ) ) {
	 ...
	 * @return void
	 */
	function _rs_woocommerce_header_cart() {
		if ( is_cart() ) {
