...
<header id="masthead">
	...
	<nav id="site-navigation" aria-label="<?php esc_attr_e( 'Main Navigation', 'rescored' ); ?>">
		<button aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'rescored' ); ?></button>
