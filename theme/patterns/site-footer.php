 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0"}}}, "color":{"background":"#f1f5f9"},"border":{"top":{"color":"var:preset|color|gray-md","width":"1px"}}},"className":"footer has-background","layout":{"type":"constrained","tagName":"footer","className":"footer"}} -->
	<div class="wp-block-group footer has-background" style="padding-top:0;padding-bottom:0;border-top-color:#e2e8f0;border-top-width:1px;background-color:#f1f5f9">
